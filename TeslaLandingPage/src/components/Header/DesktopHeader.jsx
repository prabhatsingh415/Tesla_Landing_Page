...
function DesktopHeader() {
  return (
    <motion.div className="w-full flex p-2 h-16 my-2 rounded-2xl bg-black text-black border-4 border-[var(--color-tesla-red)] shadow-[0_0_30px_5px_var(--color-tesla-red)]">
      ...
      <div className="w-3/5 mt-2 flex place-content-around">
        <motion.a
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.8 }}
          href="/"
