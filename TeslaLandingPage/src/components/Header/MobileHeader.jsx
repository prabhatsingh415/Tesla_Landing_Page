...
function MobileHeader() {
  ...
  return (
    <header className="z-50">
      <motion.div
        whileTap={{ y: 1 }}
        className="absolute top-0 right-0 visible flex justify-end m-2"
      >
        <Lottie
      ...
      <AnimatePresence initial={false}>
        {navOpen && (
          <motion.div
            ...
            className={
              "h-[calc(100vh-2rem)] mt-2 mb-2 w-[80%] flex flex-col bg-[var(--color-steel-gray)] border-solid border-[var(--color-tesla-red)] shadow-[0_0_30px_5px_var(--color-tesla-red)] ml-auto"
            }
          >
            <div className="my-3 h-2/5 flex flex-col items-start gap-3 mt-16">
              <a
                href="/TeslaLandingPage/public"
